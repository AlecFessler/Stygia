// Synthetic IPC ping-pong workload — measures roundtrip cycles for
...
// `static_syscall` import chain in tests/prof/libz/lib.zig.
...
pub fn main(cap_table_base: u64) void {
    ...
    if (cec.v1 < 16) {
        ser.print("[ipc_pp] FAIL createEc v1=");
        ser.printU64(cec.v1);
        ser.print("\n");
        return;
    }
    ...
    if (pri_r.v1 != @intFromEnum(errors.Error.OK)) {
        ser.print("[ipc_pp] FAIL priority v1=");
