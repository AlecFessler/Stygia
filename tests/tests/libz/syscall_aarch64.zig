...
// so reserve 784 bytes and write the exit sub-code at vreg 117 = [sp + 688].
...
pub fn replyTransferVmExitAsm(word: u64, attachments_ptr: [*]const u64, n: u64, subcode: u64) Regs {
    ...
    asm volatile (
        ...
        // Sub-code at vreg 117 = [sp + 688].
        \\ str %[subcode], [sp, #688]
        // Attachments in vregs [128-N..127]. Mirror of replyTransferAsm.
        \\ mov x15, %[atts_ptr]
        \\ mov x14, %[n]
        \\ mov x13, #97
        \\ sub x13, x13, x14
