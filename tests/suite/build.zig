...
const test_entries = [_]TestEntry{
    ...
    .{ .name = "acquire_vars_01", .path = "cases/acquire_vars_01.zig" },
    .{ .name = "acquire_vars_02", .path = "cases/acquire_vars_02.zig" },
    .{ .name = "acquire_vars_03", .path = "cases/acquire_vars_03.zig" },
    .{ .name = "acquire_vars_04", .path = "cases/acquire_vars_04.zig" },
    .{ .name = "acquire_vars_05", .path = "cases/acquire_vars_05.zig" },
    .{ .name = "acquire_vars_06", .path = "cases/acquire_vars_06.zig" },
    .{ .name = "acquire_vars_07", .path = "cases/acquire_vars_07.zig" },
    ...
    .{ .name = "create_var_01", .path = "cases/create_var_01.zig" },
    .{ .name = "create_var_02", .path = "cases/create_var_02.zig" },
    .{ .name = "create_var_03", .path = "cases/create_var_03.zig" },
    .{ .name = "create_var_04", .path = "cases/create_var_04.zig" },
    .{ .name = "create_var_05", .path = "cases/create_var_05.zig" },
    .{ .name = "create_var_06", .path = "cases/create_var_06.zig" },
    .{ .name = "create_var_07", .path = "cases/create_var_07.zig" },
    .{ .name = "create_var_08", .path = "cases/create_var_08.zig" },
    .{ .name = "create_var_09", .path = "cases/create_var_09.zig" },
    .{ .name = "create_var_10", .path = "cases/create_var_10.zig" },
    .{ .name = "create_var_11", .path = "cases/create_var_11.zig" },
    .{ .name = "create_var_12", .path = "cases/create_var_12.zig" },
    .{ .name = "create_var_13", .path = "cases/create_var_13.zig" },
    .{ .name = "create_var_14", .path = "cases/create_var_14.zig" },
    .{ .name = "create_var_15", .path = "cases/create_var_15.zig" },
    .{ .name = "create_var_16", .path = "cases/create_var_16.zig" },
    .{ .name = "create_var_17", .path = "cases/create_var_17.zig" },
    .{ .name = "create_var_18", .path = "cases/create_var_18.zig" },
    .{ .name = "create_var_19", .path = "cases/create_var_19.zig" },
    .{ .name = "create_var_20", .path = "cases/create_var_20.zig" },
    .{ .name = "create_var_21", .path = "cases/create_var_21.zig" },
    .{ .name = "create_var_22", .path = "cases/create_var_22.zig" },
    .{ .name = "create_var_23", .path = "cases/create_var_23.zig" },
    .{ .name = "create_var_24", .path = "cases/create_var_24.zig" },
    ...
    .{ .name = "reply_transfer_01", .path = "cases/reply_transfer_01.zig" },
    .{ .name = "reply_transfer_02", .path = "cases/reply_transfer_02.zig" },
    .{ .name = "reply_transfer_03", .path = "cases/reply_transfer_03.zig" },
    .{ .name = "reply_transfer_04", .path = "cases/reply_transfer_04.zig" },
    .{ .name = "reply_transfer_05", .path = "cases/reply_transfer_05.zig" },
    .{ .name = "reply_transfer_06", .path = "cases/reply_transfer_06.zig" },
    .{ .name = "reply_transfer_07", .path = "cases/reply_transfer_07.zig" },
    .{ .name = "reply_transfer_08", .path = "cases/reply_transfer_08.zig" },
    .{ .name = "reply_transfer_09", .path = "cases/reply_transfer_09.zig" },
    .{ .name = "reply_transfer_10", .path = "cases/reply_transfer_10.zig" },
    .{ .name = "reply_transfer_11", .path = "cases/reply_transfer_11.zig" },
    .{ .name = "reply_transfer_12", .path = "cases/reply_transfer_12.zig" },
    .{ .name = "reply_transfer_13", .path = "cases/reply_transfer_13.zig" },
    .{ .name = "reply_transfer_14", .path = "cases/reply_transfer_14.zig" },
    .{ .name = "reply_transfer_15", .path = "cases/reply_transfer_15.zig" },
    .{ .name = "reply_transfer_16", .path = "cases/reply_transfer_16.zig" },
