...
Test files:  tests/suite/cases/<section>_<NN>.zig
...
Test file naming:
  ...
  corresponding file at tests/suite/cases/<section>_<NN>.zig.
...
TESTS_DIR = os.path.join(os.path.dirname(__file__), "cases")
