...
//       runner's vmar_inner_ceiling = 0x01FF includes r|w|x|max_sz=3|
...
//       (bits 11-15) are 0 via VmarCap defaults; props reserved (bits
...
//
// Action
//   1. create_vmar(caps={r,w,max_sz=2}, props=(sz=3, cur_rwx=r|w),
//                 pages=1, preferred_base=0, device_region=0)
//   2. expect vreg 1 == E_INVAL
//
// Assertions
//   1: create_vmar returned something other than E_INVAL.
...
pub fn main(cap_table_base: u64) void {
    ...
    // vmar_inner_ceiling (max_sz field = 3).
