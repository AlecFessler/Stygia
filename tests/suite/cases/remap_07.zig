...
//
// Strategy
//   Build a regular VMAR (caps={r,w}, props={cur_rwx=0b011, sz=0,
...
//
// Assertions
//   1: setup failed — createPageFrame, createVmar, or mapPf returned
...
pub fn main(cap_table_base: u64) void {
    ...
    // §[remap] test 02). Offset 0 fits inside the 1-page VMAR.
    ...
    // passed via props on createVmar. mapPf doesn't touch cur_rwx (per
    ...
    const r_remap = syscall.remap(vmar_handle, NEW_CUR_RWX);
