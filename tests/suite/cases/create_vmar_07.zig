...
//     - caps.r/w are within the root's vmar_inner_ceiling and no x is
//       requested (test 02)
...
//
//   `lib.caps.VmarCap` declares `max_sz: u2`, so the typed wrapper
//   accepts value 3 directly via @bitCast — no raw-u16 bypass needed.
//
// Action
//   create_vmar(caps={r, w, max_sz=3}, props={cur_rwx=0b011, sz=0,
