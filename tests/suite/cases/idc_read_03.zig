...
//     - [1] must be a valid VMAR handle with the `r` cap (defeats
//       tests 01 and 02),
...
//     2. createVmar(caps={r,w}, props=0, pages=1) — VMAR.caps has `r`
...
pub fn main(cap_table_base: u64) void {
    ...
    // Step 2: VMAR with caps = r|w (the `r` cap defeats §[idc_read]
    ...
    const result = syscall.idcRead(vmar_handle, 1, 1);
