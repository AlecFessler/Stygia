...
// What's wired here is the minimum surface `capdom.virtual_machine`
...
/// zeroed 4 KiB page out of the PMM so `capdom.virtual_machine.allocVm`
...
// `map_guest` / `unmap_guest` exercise the cross-cutting capdom
